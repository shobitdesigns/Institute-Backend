            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-4">
                        ...
                        {{ Form::select('qualification_ids[]',$qualifications,$object->qualifications->pluck('id')->toArray() ??  null, ['class' => 'form-control select2 qualifications', 'multiple', 'data-placeholder' => 'Select Qualifications','required']) }}
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.name').on('input', function() {
                ...
                if ( emojiRegex.test(inputValue) || hasnumeric) {
                    $('#submit').prop('disabled', true);
                } else {
